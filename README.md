# Resumo das Configurações do Firmware CL2 Pro Plus (Marlin 1.1.9.1)
...
Plugs Ativos: USE_XMAX_PLUG, USE_YMIN_PLUG e USE_ZMAX_PLUG.
...
Passos por Milímetro (DEFAULT_AXIS_STEPS_PER_UNIT): { 53.33, 53.33, 800.0, 93.88 } (Calculados considerando polias, correias, e o Módulo de Z usando fuso de passo 4mm).
Velocidades Máximas (DEFAULT_MAX_FEEDRATE): { 200, 200, 5, 200 } mm/s.
Aceleração Máxima: { 2000, 2000, 50, 4000 } mm/s².
Aceleração Padrão de Impressão / Curso: 2000 mm/s².
